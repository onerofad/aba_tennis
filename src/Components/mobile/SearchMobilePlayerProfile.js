...
import MobileSearchProfile from "./MobileSearchProfile"

const SearchMobilePlayerProfile = () => {
        ...
        <div>
           <Sidebar.Pushable>
            ...
            >
                ...
                <Menu.Item as='a' active  onClick={() => navigate("/search/player/profile")}>
                    Player Profiles
                </Menu.Item>
...
export default SearchMobilePlayerProfile